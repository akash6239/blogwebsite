...
<!-- Mirrored from coderthemes.com/ubold/layouts/material/ecommerce-dashboard.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 10 Feb 2025 09:12:04 GMT -->
<head>
        <meta charset="utf-8" />
    ...
    <body>
            ...
            <div class="app-menu">  
                ...
                <div class="scrollbar">
                    ...
                    <ul class="menu">
                        ...
                        <li class="menu-item">
                            <a href="{{ route('viewuser') }}" class="menu-link">
                                <span class="menu-icon"><i class="mdi mdi-calendar"></i></span>
                        ...
                        <li class="menu-item">
                            <a href="{{ route('viewtag') }}" class="menu-link">
                                <span class="menu-icon"><i class="mdi mdi-calendar"></i></span>
                                <span class="menu-text">Tag </span>
                            </a>
                        </li>
                        <li class="menu-item">
                            <a href="{{ route('viewpost') }}" class="menu-link">
        ...
        <!-- Dashboard init js -->
        <script src="{{ asset('backend/assets/js/pages/ecommerce-dashboard.init.js')}}"></script>
        @stack('js')
        
    </body>

<!-- Mirrored from coderthemes.com/ubold/layouts/material/ecommerce-dashboard.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 10 Feb 2025 09:13:01 GMT -->
</html>