                    ...
                    <div class="table-responsive">
                        <table class="table table-centered table-nowrap table-hover mb-0">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <img src="{{asset('backend/assets/images/products/product-1.png')}}" alt="product-pic" height="36" />
                                ...
                                <tr>
                                    <td>
                                        <img src="{{asset('backend/assets/images/products/product-2.png')}}" alt="product-pic" height="36" />
                                ...
                                <tr>
                                    <td>
                                        <img src="{{asset('backend/assets/images/products/product-3.png')}}" alt="product-pic" height="36" />
                                ...
                                <tr>
                                    <td>
                                        <img src="{{asset('backend/assets/images/products/product-4.png')}}" alt="product-pic" height="36" />
                                ...
                                <tr>
                                    <td>
                                        <img src="{{asset('backend/assets/images/products/product-5.png')}}" alt="product-pic" height="36" />
