...
<div class="content">
    ...
    @endif
      ...
      <form action="{{ route('updatepost',$post->id) }}" method="POST" enctype="multipart/form-data">@csrf
        @method('PUT')
        <div class="row">
            <div class="col-lg-8">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="title" id="title" class="form-control" placeholder="title" value="{{ old('title',$post->title) }}">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="slug" id="slug" class="form-control" placeholder="Slug" value="{{ old('slug',$post->slug) }}">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea id="summernote" name="content" class="form-control" rows="5">{{ old('content',$post->content) }}</textarea>
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <textarea id="excerpt" name="excerpt" class="form-control" rows="5" placeholder="Write excerpt">{{ old('excerpt',$post->excerpt) }}</textarea>
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <select name="category_id[]" id="category_id" class="form-control" multiple>
                                @foreach ($categories as $item)
                                    <option value="{{ $item->id }}" 
                                        {{ in_array($item->id,
                                old('category_id', $post->categories->pluck('id')
                                        ->toArray())) ? 'selected' : '' }}>
                                        {{ $item->name }}
                                    </option>
                                @endforeach
                        ...
                        <div class="mb-3">
                            ...
                            <div class="d-flex flex-wrap">
                                <div class="form-check me-2">
                                    <input class="form-check-input" type="radio" name="status" value="active" id="inlineRadio1" {{ old('status',$post->status) == 'active'  ? 'checked': '' }}>
                                    <label class="form-check-label" for="inlineRadio1">Active</label>
                                </div>
                                <div class="form-check me-2">
                                    <input class="form-check-input" type="radio" name="status" value="inactive" id="inlineRadio2" {{ old('status',$post->status) == 'inactive'  ? 'checked': '' }} >
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <select name="is_published" id="is_published" class="form-control">
                                    <option value="yes" {{ old('is_published',$post->is_published) == 'yes'  ? 'selected': '' }}>yes</option>
                                    <option value="no" {{ old('is_published',$post->is_published) == 'no'  ? 'selected': '' }}>no</option>
                            </select>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="meta_title" class="form-control" id="meta-title" placeholder="Enter title" value="{{ old('meta_title',$post->meta_title) }}">
                            @error('meta_title')<p class="text-danger">{{ $message }}</p>@enderror
                        </div>

                        <div class="mb-3">
                            <label for="meta-keywords" class="form-label">Meta Keywords</label>
                            <input type="text" name="meta_keywords" class="form-control" id="meta-keywords" placeholder="Enter keywords" value="{{ old('meta_keywords',$post->meta_keywords) }}">
                            @error('meta_keywords')<p class="text-danger">{{ $message }}</p>@enderror
                        </div>

                        <div>
                            <label for="meta-description" class="form-label">Meta Description </label>
                            <textarea name="meta_description" class="form-control" rows="5" id="meta-description" placeholder="Please enter description">{{ old('meta_description',$post->meta_description) }}</textarea>
