            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row mb-2">
                            <div class="col-sm-4">
                                <a href="{{ route('addcategory') }}" class="btn btn-danger mb-2"><i class="mdi mdi-plus-circle me-2"></i> Add category</a>
                            </div>
                            <div class="col-sm-8">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="javascript:void(0);" 
                                                ...
                                                onclick="confirmDelete('{{ route('deletecategory', $item->id) }}')">
